...
namespace YouKe.Web.Logic
{
    ...
    public class Logic101
    {
        public byte[] Init(Stream inputSteam, string httpMethod,uint user_id)
        {
            ...
            object obj = Serialization.Deserialize(NetMessageDef.ReqCreateAccount, bytes);
            ...
            return Serialization.Serialize(new MuffinMsg(NetMessageDef.ResReturnDefaultInfo, resInfo)); 
        }
    }
}